...
export function createComment(http: HttpClient, rootUrl: string, params: CreateComment$Params, context?: HttpContext): Observable<ApiStrictHttpResponse<void>> {
  const rb = new ApiRequestBuilder(rootUrl, createComment.PATH, 'post');
  if (params) {
...
createComment.PATH = '/api/tasks/{taskId}/comments';
